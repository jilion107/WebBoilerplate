...
class AmazonApiCrawlPage extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleCrawl(e) {
        this.props.form.validateFields((err, values) => {
            if (err) {
                ...
                AmazonCrawlActions.apiCrawl(this.state.keyword);
            }
        });
    }
...
let AmazonApiCrawl = Form.create()(AmazonApiCrawlPage);
export default AmazonApiCrawl;